...
ScrollReveal().reveal('.home-img, .service-cont, .project-box, .contact form', { origin: 'bottom' });
ScrollReveal().reveal('.content h1, .about-img', { origin: 'left' });
ScrollReveal().reveal('.content p, .about-content', { origin: 'right' });

   /*==typed js==*/
const typed = new Typed('.multiple-text', {
    strings: ['UI/UX Designer', 'Frontend Web Developer', 'Graphics Designer', '/an Artist',],
    typeSpeed: 100,
    backSpeed: 100,
    backDelay: 1000,
    loop: true
